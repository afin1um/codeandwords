...
// Модель достижения: хранится локально в Room и синхронизируется с Supabase
...
public class Achievement implements Serializable {
    ...
    // Тип условия разблокировки: "LOGIN_STREAK", "TOTAL_XP" и т.д.
    ...
    // Максимальное значение для отображения прогресс-бара в UI
    @ColumnInfo(name = "max_progress")
    @SerializedName("max_progress")
    private Integer maxProgress;

    // Имя ресурса иконки в res/drawable
    ...
    public Achievement(Long id, String title, String description, Integer xpReward,
                       ...
                       Integer maxProgress, String iconResName) {
        this.id = id;
        this.title = title;
